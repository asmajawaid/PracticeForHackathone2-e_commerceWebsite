...
export default function Products() {
  return (
    <>
    <div className='absolute w-[1170px] h-[518px] gap-[60px] mt-[1868px] ml-[135px] flex flex-col items-start p-0'>
       
    <div className="w-[1170px] h-[108px] gap-[611px] flex flex-row items-end p-0">
        <div className=" w-[400px] h-[108px] gap-[20px] flex flex-col items-start p-0 ">
            <div className="w-[125px] h-[40px] gap-[16px] flex flex-row items-center p-0">
              <div className="w-[20px] h-[40px] rounded-[4px] bg-[#DB4444]"></div>
              <div className="w-[89px] h-[20px] font-semibold text-[16px] leading-5 text-[#DB4444]">
              This Month
              </div>
            </div>
            <div className="w-[400px] h-[48px] font-semibold text-4xl tracking-wide ">
        ...
        {/* BUTTON */}
        <div className="bg-[#DB4444] w-[159px] h-[56px] gap-[10px] flex flex-row items-center py-[16px] px-[48px] rounded-sm cursor-pointer">
        <div className='text-[#fafafa] w-[63px] h-[24px] font-medium text-[16px] leading-6'>View All</div>
        </div>
